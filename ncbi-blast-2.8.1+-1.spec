...
%define shortsummary NCBI BLAST+ sequence alignment package
Summary: %{shortsummary}

# Give the package a base name
%define pkg_base_name blast
...
Source:    ftp://ftp.ncbi.nlm.nih.gov/blast/executables/blast+/LATEST/ncbi-blast-2.8.1+-x64-linux.tar.gz
...
%setup -n ncbi-%{pkg_base_name}-%{pkg_version}+
