...
%define shortsummary User-friendly tools for exploring deep-sequencing data
Summary: %{shortsummary}

# Give the package a base name
%define pkg_base_name deepTools
...
module load python2
tar -xzvf %{_sourcedir}/%{pkg_base_name}-%{pkg_version}.tar.gz
pip install --user ./%{pkg_base_name}-%{pkg_version}
