...
%define shortsummary Picard comprises Java-based command-line utilities that manipulate SAM files, and a Java API (SAM-JDK) for creating new programs that read and write SAM files. Both SAM text format and SAM binary (BAM) format are supported.
...
Packager:  TACC - eferlanti@tacc.utexas.edu
Source:    https://github.com/broadinstitute/picard/releases/download/%{major_version}.%{minor_version}.%{patch_version}/picard.jar
%package %{PACKAGE}
Summary: %{shortsummary}
Group:   Applications/Life Sciences
%description package
...
cp %{_topdir}/SOURCES/picard.jar $RPM_BUILD_ROOT/%{INSTALL_DIR}/
...
java <jvm-args> -jar $%{MODULE_VAR}_DIR/picard.jar <picard-args>
