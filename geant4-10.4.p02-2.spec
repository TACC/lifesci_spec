...
########## Install Xerces C for XML support (optional)

cd install
mkdir xercesc/
wget http://mirrors.koehn.com/apache//xerces/c/3/sources/xerces-c-3.2.2.tar.gz
...
cmake   \
	...
	-DCMAKE_C_FLAGS="-O3 -DNDEBUG -xAVX -axCORE-AVX2" \
	-DCMAKE_CXX_FLAGS="-O3 -DNDEBUG -xAVX -axCORE-AVX2" \
	-DCMAKE_INSTALL_PREFIX="../../xercesc" \
	../
...
cmake   \
	...
	-DGEANT4_INSTALL_DATADIR=/scratch/projects/tacc/bio/geant4/%{major_version}.%{minor_version}.%{patch_version}/ \
	-DGEANT4_BUILD_MULTITHREADED=ON \
	-DGEANT4_USE_GDML=ON \
	-DXERCESC_ROOT_DIR="${PWD}/../install/xercesc/" \
	../
...
cmake	\
	...
	-DCMAKE_CXX_FLAGS="-O3 -DNDEBUG %{TACC_OPT} -w1 -Wno-non-virtual-dtor -Wpointer-arith -Wwrite-strings -fp-model precise" \
	-DCMAKE_C_FLAGS="-O3 -DNDEBUG %{TACC_OPT}" \
	-DGeant4_DIR="$PWD/../install/lib64/Geant4-10.4.2" \
...
When compiling serial or multithreaded code with this version of %{pkg_base_name}, do:

  cmake -DCMAKE_C_COMPILER=icc \
        -DCMAKE_CXX_COMPILER=icpc \
        /path/to/code/

When compiling MPI code with this version of %{pkg_base_name}, do:

  cmake -DCMAKE_C_COMPILER=icc \
        -DCMAKE_CXX_COMPILER=icpc \
        -DG4mpi_DIR=$TACC_GEANT4_MPI/lib64/G4mpi-10.4.2 \
        /path/to/code/
...
setenv( "G4ABLADATA",        "%{GEANT4DATA}/G4ABLA3.1")
setenv( "G4LEDATA",          "%{GEANT4DATA}/G4EMLOW7.3")
setenv( "G4ENSDFSTATEDATA",  "%{GEANT4DATA}/G4ENSDFSTATE2.2")
...
setenv( "G4TENDLDATA",       "%{GEANT4DATA}/G4TENDL1.3.2")
setenv( "G4LEVELGAMMADATA",  "%{GEANT4DATA}/PhotonEvaporation5.2")
setenv( "G4RADIOACTIVEDATA", "%{GEANT4DATA}/RadioactiveDecay5.2")
setenv( "G4REALSURFACEDATA", "%{GEANT4DATA}/RealSurface2.1.1")

setenv( "G4INCLUDE",          "%{INSTALL_DIR}/include/Geant4")
setenv( "G4INSTALL",          "%{INSTALL_DIR}/share/Geant4-10.4.2/geant4make")
setenv( "G4LIB",              "%{INSTALL_DIR}/lib64/Geant4-10.4.2")
...
prereq("intel/18.0.2", "cray_mpich/7.7.3", "cmake/3.12.3")
