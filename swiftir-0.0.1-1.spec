...
%define shortsummary Signal Whitening Fourier Transform Image Registration
Summary: %{shortsummary}

# Give the package a base name
%define pkg_base_name swiftir
...
URL:       https://mmbios.pitt.edu/swift-ir-home
Packager:  TACC - jawon@tacc.utexas.edu
Source:    swiftir-%{major_version}.%{minor_version}.%{patch_version}.tar.gz
...
##################################
module load intel/18.0.0 python2/2.7.15
##################################
...
pip install opencv-python --ignore-installed --force-reinstall --prefix=$PWD
cp -r bin docs lib pygtk-2.24.0 python source test.py tests $RPM_BUILD_ROOT/%{INSTALL_DIR}/
...
whatis("Category: image analysis, electron microscopy")
whatis("Keywords: Biology")
whatis("Description: %{shortsummary}")
whatis("URL: %{url}")

prepend_path("PATH",		"%{INSTALL_DIR}/python")
prepend_path("PYTHONPATH",      "%{INSTALL_DIR}/pygtk-2.24.0:%{INSTALL_DIR}/pygtk-2.24.0/gtk")
setenv("%{MODULE_VAR}_DIR",     "%{INSTALL_DIR}")
setenv("%{MODULE_VAR}_BIN",     "%{INSTALL_DIR}/python")
EOF
