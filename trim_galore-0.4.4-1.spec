...
%define shortsummary Consistent quality and adapter trimming for RRBS or standard FastQ files
Summary: %{shortsummary}

# Give the package a base name
%define pkg_base_name trim_galore
...
Source:    https://www.bioinformatics.babraham.ac.uk/projects/trim_galore/%{pkg_base_name}-%{pkg_version}.tar.gz
