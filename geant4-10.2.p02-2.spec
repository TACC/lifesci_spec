...
cmake  \
       -DGEANT4_INSTALL_DATADIR=%{GEANT4DATA} \
       -DCMAKE_INSTALL_PREFIX=%{INSTALL_DIR} \
       -DGEANT4_BUILD_MULTITHREADED=ON \
       ../


make DESTDIR=$RPM_BUILD_ROOT -j8
...
cmake  \
       -DGeant4_DIR="/opt/apps/gcc4_9/cray_mpich_7_3/geant4/10.2.p02/lib64/Geant4-10.2.2" \
       -DCMAKE_INSTALL_PREFIX=%{INSTALL_DIR}/mpi \
       ../examples/extended/parallel/MPI/source

make DESTDIR=$RPM_BUILD_ROOT -j4
make DESTDIR=$RPM_BUILD_ROOT install
...
#cp -r install/bin/     $RPM_BUILD_ROOT/%{INSTALL_DIR}/
#cp -r install/include/ $RPM_BUILD_ROOT/%{INSTALL_DIR}/
#cp -r install/lib64/   $RPM_BUILD_ROOT/%{INSTALL_DIR}/
#cp -r install/share/   $RPM_BUILD_ROOT/%{INSTALL_DIR}/
#cp -r install/mpi/     $RPM_BUILD_ROOT/%{INSTALL_DIR}/
...
The data files can be found in $%{MODULE_VAR}_SHARE
...
setenv( "%{MODULE_VAR}_SHARE",   "/scratch/projects/tacc/bio/geant4/10.2.p02")
...
# ./build_rpm.sh --gcc=49 --cmpich=7_3 geant4-10.2.p02-2.spec # ls5
#
# In apps dir: 
